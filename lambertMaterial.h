...
namespace RayTracing
{
    ...
    protected:
    public:
        LambertMaterial(const Vector3d &reflectance) : Material(Vector3d(), reflectance){};
        ...
        virtual Vector3d sample(Random &random, const Vector3d &in, const Vector3d &normal, double *pdf, Vector3d *brdfValue) const
        {
            ...
            // 次に反射する方向を計算する
            const Vector3d dir = Sampling::cosineWeightHemisphereSurface(random, nowNormal, tangent, binormal);
